#ifndef OFFICAL_JUDGE_HANDLER_H
#define OFFICAL_JUDGE_HANDLER_H
#include "main.h"
...
uint32_t myVerify_CRC16_Check_Sum(uint8_t *pchMessage, uint32_t dwLength)
{
    ...
    wExpected = myGet_CRC16_Check_Sum ((uint8_t *) pchMessage, dwLength - 2, myCRC16_INIT);
...
pchMessage[dwLength-2] = (uint8_t)(wCRC & 0xff);
pchMessage[dwLength-1] = (uint8_t)((wCRC >> 8)& 0xff);
}
