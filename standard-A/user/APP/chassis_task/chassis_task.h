...
#define CHASSIS_VX_RC_SEN 0.012f//0.0012f
//遥控器左右摇杆（max 660）转成车体左右速度（m/s）的比例
#define CHASSIS_VY_RC_SEN 0.012f//0.0012f
//跟随底盘yaw模式下，遥控器的yaw遥杆（max 660）增加到车体角度的比例
#define CHASSIS_ANGLE_Z_RC_SEN 0.000002f
//不跟随云台的时候 遥控器的yaw遥杆（max 660）转化成车体旋转速度的比例
#define CHASSIS_WZ_RC_SEN 0.01f//0.01f
...
#define CHASSIS_LEFT_ROLL_KEY KEY_PRESSED_OFFSET_Q
#define CHASSIS_RIGHT_ROLL_KEY KEY_PRESSED_OFFSET_E
#define ENHANCE KEY_PRESSED_OFFSET_SHIFT
#define CHASSIS_TURN_180 KEY_PRESSED_OFFSET_R
//m3508转化成底盘速度(m/s)的比例，做两个宏 是因为可能换电机需要更换比例
#define M3508_MOTOR_RPM_TO_VECTOR 0.000415809748903494517209f
#define CHASSIS_MOTOR_RPM_TO_VECTOR_SEN M3508_MOTOR_RPM_TO_VECTOR

//底盘电机最大速度
#define MAX_WHEEL_SPEED 8.0f//4.0f
//底盘运动过程最大前进速度
#define NORMAL_MAX_CHASSIS_SPEED_X 6.0f//2.5
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 6.0f//2.5
//底盘设置旋转速度，设置前后左右轮不同设定速度的比例分权 0为在几何中心，不需要补偿
#define CHASSIS_WZ_SET_SCALE 1.0f//0.1
...
extern PidTypeDef pidForChassis;
